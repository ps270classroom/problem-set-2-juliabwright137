...
number_of_candidates <- (fb_ads$cand_name)

print(number_of_candidates)

# table with incumbency status
incumbency_table <- (group_by(fb_ads, incumbency)) |>
                       summarize(number_of_candidates =(cand_name))

# display table 
knitr::kable(incumbency_table)
```

There are 6928 candidates. 
